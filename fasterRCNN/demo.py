...
def parse_args():
  ...
  parser.add_argument('--load_dir', dest='load_dir',
                      ...
                      default="/media/wow/disk2/STT2/STTran-main/fasterRCNN/models")
...
if __name__ == '__main__':
  ...
  input_dir='/media/wow/disk2/STT2/STTran-main/fasterRCNN/models'
  load_name = os.path.join(input_dir,
    'faster_rcnn_res_{}_{}_{}.pth'.format(args.checksession, args.checkepoch, args.checkpoint))
  ...
  if webcam_num >= 0 :
    cap = cv2.VideoCapture('/media/wow/disk2/AG/test.mp4')
    num_images = 0
  else:
